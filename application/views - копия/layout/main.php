...
<head>
    ...
    <link media="screen" href="<?php echo base_url();?>assets/fancyBox/source/jquery.fancybox.css?v=2.1.4" type="text/css" rel="stylesheet">
    ...
    <?php if($this->uri->segment(1) == 'product'): ?>
        <link type="text/css" rel="stylesheet" media="screen" href="<?php echo base_url();?>assets/fancyBox/source/helpers/jquery.fancybox-buttons.css">
        <link type="text/css" rel="stylesheet" media="screen" href="<?php echo base_url();?>assets/fancyBox/source/helpers/jquery.fancybox-thumbs.css">
    <?php endif; ?>
...
<div class="container container_12" id="main">
    <header>
        ...
        <div class="grid_1">
            <a class="various fancybox.ajax" href="<?php echo base_url();?>cart"><img src="<?php echo base_url();?>images/cart.png"></a>
        </div>
        <div class="clear">&nbsp;</div>
        <nav class="">
            <ul>
...
<script src="<?php echo base_url();?>assets/fancyBox/lib/jquery-1.9.0.min.js"></script>
