    ...
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('delivery_method/search'), 'role="search" class="form"') ;?>       
          ...
          <table class="table table-hover table-condensed">
            ...
            <tbody>
              ...
              <tr>
               ...
               <td><?php echo $delivery_method['delivery_name']; ?></td>
               
               <td><?if ($delivery_method['is_active'] == 1) {echo 'ДА';}else{echo 'НЕТ';}?></td>
                ...
                <td>    
					...
					/*
                                  echo anchor(
                                          site_url('delivery_method/show/' . $delivery_method['delivery_id']),
                   ...
                   */
				   ?>
                    ...
                    <?php
                                  echo anchor(
                                          site_url('delivery_method/edit/' . $delivery_method['delivery_id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('delivery_method/destroy/' . $delivery_method['delivery_id']),
