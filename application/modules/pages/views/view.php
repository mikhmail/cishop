    ...
    <header class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-9">
                 ...
                 <?php echo form_open(site_url('pages/search'), 'role="search" class="form"') ;?>
         ...
         <?php if ($pagess) : ?>
          <table class="table table-hover table-condensed">
            ...
            <tbody>
              ...
              <tr>
              	<td><?php echo $pages['post_id']; ?> </td>
               
               <td><?php echo $pages['post_title']; ?></td>
               
               <td><?php echo $pages['post_description']; ?></td>
               

               
               <td><?php echo $pages['post_url']; ?></td>
                ...
                <td>    
                    ...
                    /*
                                  echo anchor(
                                          site_url('posts/show/' . $pages['post_id']),
                   ...
                   */
                    ...
                    <?php
                                  echo anchor(
                                          site_url('pages/edit/' . $pages['post_id']),
                   ...
                   <?php
                                  echo anchor(
                                          site_url('pages/destroy/' . $pages['post_id']),
