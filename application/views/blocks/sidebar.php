    ...
    <ul>
        <?php if(!empty($catalogs)):?>
            <?php foreach($catalogs as $cats): ?>
                <li><a href="<?php echo base_url();?>catalogs/<?=$cats->catalog_id;?>/<?=$cats->catalog_url;?>/0/"><?=$cats->catalog_title;?></a></li>
                        ...
                        <ul>
                            ...
                            if(!empty($categories)): //var_dump($categories);die;?>
                                <?php foreach($categories as $c): ?>
                                    <li><a href="<?php echo base_url();?>category/<?=$c->category_id;?>/<?=$c->category_url;?>/0/"><?=$c->category_title;?></a></li>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
                    </li>
